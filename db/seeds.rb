...
if AccidentType.count == 0
  AccidentType.create!(:name => "Auto", :created_user => admin_user.login_name).lock_record
  AccidentType.create!(:name => "Employment", :created_user => admin_user.login_name).lock_record
  AccidentType.create!(:name => "Not an Accident", :created_user => admin_user.login_name).lock_record
  AccidentType.create!(:name => "Other", :created_user => admin_user.login_name).lock_record
...
if OfficeType.count == 0
  OfficeType.create(:name => "Service Location", :perm => true, :created_user => admin_user.login_name)
  OfficeType.create(:name => "Billing Location", :perm => true, :created_user => admin_user.login_name)
