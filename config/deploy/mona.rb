...
role :web, "50.243.93.209"                          # Your HTTP server, Apache/etc
role :app, "50.243.93.209"                          # This may be the same as your `Web` server
role :db,  "50.243.93.209", :primary => true # This is where Rails migrations will run
...
namespace :deploy do
   ...
   task :migrate do
     ...
     run "cp -f #{deploy_to}/current/config/database/mona.yml #{deploy_to}/current/config/database.yml"
